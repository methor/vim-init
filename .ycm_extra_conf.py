...
blade_conf = imp.load_source('module_name', os.path.join(DIR_OF_THIS_SCRIPT, 'blade_clang_conf.py'))
flags = blade_conf.flags
expandGlob = blade_conf.expandGlob
